        ...
        else if (canTrack)
        {
            ...
            for (int t = 0; t < iterNum; t++)
            {
                for (int n = 0; n < features.size(); n++)
                {
                    ...
                    features[n].x = features[n].x * (1 + z.at<float>(0, 0)) + features[n].y * z.at<float>(1, 0) + z.at<float>(4, 1);
                    features[n].y = features[n].x * z.at<float>(2, 0) + features[n].y * (1 + z.at<float>(3, 0)) + z.at<float>(5, 1);
                }
            }
        }
